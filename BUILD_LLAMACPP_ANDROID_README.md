...
Backend performance on Snapdragon device:

| Backend | Model | Load Time | Notes |
|---------|-------|-----------|-------|
| OpenCL (GPU) | Qwen2-VL-2B Q4_K_M | ~216ms | Adreno GPU, --n-gpu-layers 999 |
| Hexagon (HTP x4) | Qwen2-VL-2B Q4_K_M | ~209ms | HTP0-3, GGML_HEXAGON_NDEV=4 |
| CPU | Qwen2-VL-2B Q4_K_M | ~250ms | --n-gpu-layers 0 |
